[![Build Status](https://travis-ci.org/codedoctor/hapi-user-store-multi-tenant.svg?branch=master)](https://travis-ci.org/codedoctor/hapi-user-store-multi-tenant)
